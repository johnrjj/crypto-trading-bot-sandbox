...
const calculateRsiSubsequent = (prevGainAvg: number, prevLossAvg: number, currentGain: number, currentLoss: number, periods: number = DEFAULT_PERIODS) => {
