...
function requestData() {
  ...
  if (connection.connected) {
    ...
    var m2 = '~m~75~m~{"m":"resolve_symbol","p":["cs_A81hNsYTGtqz","symbol_1","BITSTAMP:BTCUSD"]}'
    // var m2 = '~m~75~m~{"m":"resolve_symbol","p":["cs_A81hNsYTGtqz","symbol_1","'+process.argv[2]+'"]}'
    var m3 = '~m~76~m~{"m":"create_series","p":["cs_A81hNsYTGtqz","s1","s1","symbol_1","5",10000]}'
...
client.connect('wss://data.tradingview.com/socket.io/websocket' , null,'https://www.tradingview.com', headers);